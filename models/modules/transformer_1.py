...
class Transformer_attn(nn.Module):
    ...
    def forward(self, input: torch.Tensor, logdet=0, reverse=False, permute=False):
     if not reverse:
        ...
        q1= torch.nn.functional.conv2d(z_m,self.convq)#Convq
        ...
        k1= torch.nn.functional.conv2d(z_m,self.convk)#Convk
        ...
        q1= torch.nn.functional.conv2d(rev_rearrange,self.convq)
        ...
        k1= torch.nn.functional.conv2d(rev_rearrange,self.convk)
        ...
        attn = (s((torch.matmul(full_inp_q1_rev, full_inp_k1_rev.permute(0, 2, 1))/self.scale)))*attn_mask
